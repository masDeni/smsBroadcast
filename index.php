        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                <form class="bootstrap-form-with-validation">
                    <h2 class="text-center">Form SMS</h2>
                    <div class="form-group">
                        <label class="control-label" for="text-input">Sender </label>
                        <input class="form-control" type="text" name="text-input" id="text-input">
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="email-input">Tujuan </label>
                        <input class="form-control" type="text" name="text-input" id="text-input">
                    </div>
                    <div class="form-group">
                        <div class="checkbox">
                            <label class="control-label" for="checkbox-input">
                                <input type="checkbox" name="checkbox-input">file xlsx</label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="control-label" for="textarea-input">Pesan </label>
