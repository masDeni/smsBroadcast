...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table">
                    <table class="table table-bordered table-hovered dataTable" role="grid" id="outboxlist">
                        <thead>
                            <tr>
                                <th>tujuan </th>
                                <th>Pesan</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                      <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="action">pilih
                                      <span class="caret"></span></button>
                                      <ul class="dropdown-menu">
                                        <li><a href="#">hapus</a></li>
                                        <li><a href="#">kirim ulang</a></li>
                                      </ul>
                                    </div>
                                </td>
                            </tr>
